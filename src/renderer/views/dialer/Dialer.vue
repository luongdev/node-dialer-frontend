<template>
  ...
  <div class="flex flex-col items-center justify-center w-full h-screen">
    ...
    <div class="relative mb-6 max-w-[75%]">
      <a-input id="dialer-input" size="large" v-model:value="inputStr" class="text-3xl mb-4" :maxlength="maxLength">
        <template #suffix>
...
import DID from "@renderer/views/dialer/DID.vue";
