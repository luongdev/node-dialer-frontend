<template>
    <div class="bg-black flex flex-col px-2 justify-start py-4">
        <button class="w-16 h-16 my-2 text-5xl flex items-center justify-center bg-green-500 text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 
